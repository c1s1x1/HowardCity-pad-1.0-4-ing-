...
- (void)viewDidLoad {
    ...
    self.tabBarItem.title = @"任务23333";   //❌sets tab bar title. Even the `tabBarItem.title` changed, this will be ignored in tabbar.
    ...
    self.leftMenuTitle = @"发布";
    self.rightMenuTitle = @"执行";
    self.leftViewController = [PublishViewController new];
    self.rightViewController = [ManageViewController new];
}
