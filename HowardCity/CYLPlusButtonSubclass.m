...
//                                                    otherButtonTitles:@"拍照", @"从相册选取", @"come soon", nil];
...
//    HCLog(@"asdfadfasdfasdf");
//}

#pragma mark - CYLPlusButtonSubclassing

+ (UIViewController *)plusChildViewController {
    PlusButtonViewController *plusChildViewController = [[PlusButtonViewController alloc] init];
    plusChildViewController.view.backgroundColor = HCColor(55, 106, 133, 1);
    plusChildViewController.navigationItem.title = @"功能选择";
