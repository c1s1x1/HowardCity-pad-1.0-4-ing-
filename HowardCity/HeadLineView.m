...
-(void)setCurrentIndex:(NSInteger)CurrentIndex
{
    ...
    if ([_delegate respondsToSelector:@selector(refreshHeadLine:IsClickAgain:)]) {
        [_delegate refreshHeadLine:_CurrentIndex IsClickAgain:flag];
    }
}
//刷新界面
            ...
            if (labelView.tag==index) {
                if (labelView.tag==0) {
                    ...
                    if (!flag) {
                        ...
                        label1.backgroundColor=JXColor(240, 150, 33, 1);
                        flag = NO;
                    }
                    ...
                    if (!flag) {
                        ...
                        label2.backgroundColor=JXColor(240, 150, 33, 1);
                        flag = NO;
                    }
                }else{
                    if (!flag) {
                        ...
                        label3.backgroundColor=JXColor(240, 150, 33, 1);
                        flag = NO;
                    }
                }
...
-(void)setTitleArray:(NSArray *)titleArray
{
    ...
    for (int i=0; i<_titleArray.count; i++) {
        ...
        btn.frame=CGRectMake(i*width, 0, width, 38);
        btn.tag=i;
...
//        [btn setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 10, 0)];
        ...
        if (i==0) {
            currentSelected=btn;
            //深绿线
            label1=[[UILabel alloc]initWithFrame:CGRectMake(0, 35.5, WIDTH/3, 2.5)];
            label1.backgroundColor=JXColor(179, 211, 85, 1);
...
//            [btn setBackgroundColor:[UIColor whiteColor]];
            ...
            //绿线
            label2=[[UILabel alloc]initWithFrame:CGRectMake(width, 35.5, WIDTH/3, 2.5)];
...
//            [btn setBackgroundColor:[UIColor whiteColor]];
            ...
            //绿线
            label3=[[UILabel alloc]initWithFrame:CGRectMake(width * 2, 35.5, WIDTH/3, 2.5)];
