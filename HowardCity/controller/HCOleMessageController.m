...
@interface HCOleMessageController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation HCOleMessageController
...
-(void)initDate{
    if (![HowardCityTool TimeOut:self]) {
        ...
        NSString *LoginUrl = [[NSString alloc]initWithFormat:@"%@action=getUnreadInformations&access_token=%@",HCInterfacePrefix,self.account.access_token];
#pragma mark 拼接url
